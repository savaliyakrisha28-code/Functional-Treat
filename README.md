...
<h1 align="center">📊 DATA ANALYZER AND TRANSFORMER</h1>
...
The user can choose between two sorting options:
...
- How to use recursion for factorial calculation.
- How to filter and sort list data.
- How to use the `match-case` statement.
- How to calculate statistical values.
- How to create a menu-driven console application.
- How to handle user input and conditions.
